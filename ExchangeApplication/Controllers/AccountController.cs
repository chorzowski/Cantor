...
namespace ExchangeApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var info = new Info() { FirstName = model.FirstName, LastName = model.LastName, Address = model.Address, TelephoneNumber = model.TelephoneNumber };
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, info = info };
